...
> **This is a fork of [ocbMaurice's OcbCustomTextures](https://github.com/OCB7D2D/OcbCustomTextures)** with compatibility patches for [PaintUnlocked](https://github.com/Kitsune-Den/PaintUnlocked), which breaks the 255 paint texture limit in 7 Days to Die.
>
...
1. Install [PaintUnlocked](https://github.com/Kitsune-Den/PaintUnlocked) on server and all clients.
